#!/bin/bash
# ============================================================
# DeployCenter 2.7.7 — Build Release Package
# מריץ את זה על מחשב הפיתוח (לא על שרת הייצור)
# ============================================================
# פלט: deploycenter-docker-v2.7.7.tar
#       (כולל images: deploycenter-api:2.7.7 + deploycenter-frontend:2.7.7 + postgres:16-alpine)
# ============================================================
...
echo ""
echo " העבר לשרת RHEL:"
echo "   scp $RELEASE_DIR/* user@SERVER:/tmp/deploycenter-2.7.7/"
echo "   ssh user@SERVER 'cd /tmp/deploycenter-2.7.7 && sudo bash install-docker.sh'"
echo "======================================================"
