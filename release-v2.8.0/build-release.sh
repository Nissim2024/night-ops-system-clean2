#!/bin/bash
# ============================================================
# DeployCenter 2.8.0 — Build Release Package
# מריץ את זה על מחשב הפיתוח (לא על שרת הייצור)
# ============================================================
# פלט: deploycenter-docker-v2.8.0.tar
#       (כולל images: deploycenter-api:2.8.0 + deploycenter-frontend:2.8.0 + postgres:16-alpine)
# ============================================================
...
echo ""
echo " העבר לשרת RHEL:"
echo "   scp $RELEASE_DIR/* user@SERVER:/tmp/deploycenter-2.8.0/"
echo "   ssh user@SERVER 'cd /tmp/deploycenter-2.8.0 && sudo bash install-docker.sh'"
echo "======================================================"
