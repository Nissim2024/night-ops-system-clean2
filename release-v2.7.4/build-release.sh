#!/bin/bash
# ============================================================
# DeployCenter 2.7.4 — Build Release Package
# מריץ את זה על מחשב הפיתוח (לא על שרת הייצור)
# ============================================================
# פלט: deploycenter-docker-v2.7.4.tar
#       (כולל images: deploycenter-api:2.7.4 + deploycenter-frontend:2.7.4 + postgres:16-alpine)
# ============================================================
...
echo ""
echo " העבר לשרת RHEL:"
echo "   scp $RELEASE_DIR/* user@SERVER:/tmp/deploycenter-2.7.4/"
echo "   ssh user@SERVER 'cd /tmp/deploycenter-2.7.4 && sudo bash install-docker.sh'"
echo "======================================================"
